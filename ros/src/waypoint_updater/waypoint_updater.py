...
class WaypointUpdater(object):
    def __init__(self):
        ...
        # Check message type for traffic waypoint and obstacle waypoint
    ...
    def loop(self):
        ...
        while not rospy.is_shutdown():
            if self.pose and self.base_waypoints:
                closest_way_point_idx = self.get_closest_waypoint_idx()
                self.publish_waypoints(closest_way_point_idx)
            rate.sleep()
